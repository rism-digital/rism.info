...
Der RISM Catalog kann über die RISM-Webseite oder [opac.rism.info](https://opac.rism.info/){:target="_blank"} erreicht werden. Er wird ermöglicht durch eine Kooperation zwischen der [Bayerischen Staatsbibliothek](http://www.bsb-muenchen.de/ "www.bsb-muenchen.de/") (München) und der [Staatsbibliothek zu Berlin](http://staatsbibliothek-berlin.de/ "http://staatsbibliothek-berlin.de/"), Preußischer Kulturbesitz, im Rahmen des RISM Editorial Network. Verantwortlich für den Betrieb und die technische Umsetzung des RISM Catalogs ist die Bayerische Staatsbibliothek München.
