...
I (Jennifer Ward) attended the [Music Encoding Conference](http://music-encoding.org/conference){:target="_blank"} in Florence, Italy, from 18-20 May 2015. The [full program](https://music-encoding.org/conference/2015/){:target="_blank"} included 19 presentations and 11 poster sessions.
...
[The Enhancing Music Notation Addressability (EMA) project](https://mith.umd.edu/research/enhancing-music-notation-addressability/){:target="_blank"}
...
The next conference will be held at McGill University in 2016. Discussion about MEI takes place throughout the year on the [mailing list, MEI-L](https://music-encoding.org/community/community-contacts.html){:target="_blank"}.
