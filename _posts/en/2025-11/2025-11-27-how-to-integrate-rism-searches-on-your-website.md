---
layout: post
title: "How to Integrate RISM Searches on Your Website"
date: 2025-11-27
lang: en
post: true
...
Although setting up such specialized searches through the [RISM Online Search API](https://rism.online/docs/api/api/){:blank} is by no means rocket science, it does require some technical expertise that not every one of our readers might have. That said, the person maintaining your website should take a look at the brief description of the [technical details](/community/integrating-rism-searches-on-website.html){:blank}. We hope that this possibility might be of interest to some of you, and would love to hear back (at [contact@rism.info](mailto:contact@rism.info){:blank}) from any institutions or individuals who take the time to integrate a RISM search on their website.
