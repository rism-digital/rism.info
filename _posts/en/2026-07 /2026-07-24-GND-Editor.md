---
layout: post
title: 'The GND Editor and the Work Level in RISM'
date: 2026-07-24
lang: en
post: true
...
{% include image file="/images/news/2026-07/Screenshot_Layout_GND_Editor.jpg" %} 
...
Such direct access to the GND is a unique feature and is of great relevance for the German-speaking musicological community. At the same time, the GND Editor is an important contribution to the newly created work level in RISM, which includes work nodes, works, and the potential to create [catalogs of works](https://rism.info/rism_digital_center/2026/04/30/two-born-digital-thematic-catalogs.html){:blank} via Muscat.
 
**Work nodes**

{% include image file="/images/news/2026-07/Screenshot_Worknode_1336.jpg" %}
...
{% include image file="/images/news/2026-07/Screenshot_Work_Mendelssohn_Paulus.jpg" %}
...
The implementation of the work level offers significant new opportunities for the analysis of RISM data, while also improving its interoperability: thanks to the inclusion of GND IDs, RISM becomes interoperable with other data hubs, such as the [musiconn.performance](https://performance.musiconn.de){:blank} repository, which also makes use of GND work authority IDs. An authority data ID is also essential for searching in higher-level systems – for example, the [NFDI4Culture Knowledge Graph](https://nfdi4culture.de/services/details/culture-knowledge-graph.html){:blank} or other international LOD initiatives – as it allows information about works to be aggregated.
