...
At the [IAML Congress in Kraków](/publications/iaml-congresses/2019.html "Opens internal link in current window") this summer, the General Assembly approved the creation of a [Project Group on RISM Series C](https://www.iaml.info/project-group-rism-series-c){:target="_blank"}. It will be a pilot project to update the [RISM Series C directory of music holding institutions](/publications.html#c2620 "Opens internal link in current window"), available online through the [Directory of Library Sigla](/sigla.html "Opens internal link in current window"), in collaboration with the RISM Zentralredaktion in Frankfurt.
