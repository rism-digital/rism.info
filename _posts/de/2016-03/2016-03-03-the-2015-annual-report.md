...
Hier einige Highlights aus dem Jahresbericht, dessen ausführliche Fassung Sie auf der [RISM Webseite](/publications/annual-reports/2015.html) nachlesen können.
...
**weitere Datenimporte**: RISM arbeitet mit [RISM France](http://ccfr.bnf.fr/){:target="_blank"} und [ICCU (Italy)](https://opac.sbn.it/opacsbn/opac/iccu/avanzata.jsp){:target="_blank"} an einem Transfer, um deren Daten zu Musikquellen in die RISM-Datenbank zu integrieren.
