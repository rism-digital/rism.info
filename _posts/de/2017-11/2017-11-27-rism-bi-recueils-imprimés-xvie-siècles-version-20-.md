...
_Eine erweiterte Version der Einträge aus der Serie B/I bis 1550 wurde 2015 in den RISM [Online-Katalog](http://www.rism.info/de/home/newsdetails/article/64/printed-music-ai-and-bi-now-in-risms-online-catalog.html){:target="_blank"} eingespielt. Dank der Unterstützung durch den Kulturfonds der_ _[VG Musikedition](https://www.vg-musikedition.de/){:target="_blank"} (Kassel) erfolgt seit April dieses Jahres_ _eine Überarbeitung der Einträge durch unseren studentischen Mitarbeiter Martin Bierwisch. Im Folgenden ein kurzer Bericht seiner Eindrücke und Erfahrungen:_
