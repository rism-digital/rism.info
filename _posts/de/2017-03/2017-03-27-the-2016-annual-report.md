...
Wir haben den Jahresbericht 2016 auf unserer Website [hier abrufbar](/de/publikationen/jahresberichte.html "Opens internal link in current window") veröffentlicht. Einige Punkte möchten wir dennoch hier hervorheben. Die Freischaltung von Muscat zweifellos das größte Ereignis des Jahres, daher beginnen damit ...

**Muscat!:** Unser neues Erfassungsprogramm [Muscat](/de/community/muscat.html#c3306 "Opens internal link in current window") konnte im November letzten Jahres fertig gestellt und freigeschaltet werden. Mehr als 150 Personen auf der ganzen Welt nutzen es seitdem. Einarbeitungen, Workshops und Tutorials wurden erarbeitet, um den Umstieg von Kallisto auf das neue Programm zu erleichtern.
...
**Serie C:** RISM arbeitet mit der IAML-Projektgruppe [Access to Music Archives](http://www.iaml.info/project-group-access-music-archives){:target="_blank"} (AMA) zusammen, um die [Serie C, Directory of Music Research Libraries](/de/publikationen.html#c2620 "Opens internal link in current window") zu aktualisieren und als Online-Datenbank zur Verfügung zu stellen.
