...
The RISM Catalog can be accessed through the RISM homepage or from [opac.rism.info](https://opac.rism.info){:target="_blank"}. It is made possible through a partnership between the [Bavarian State Library](https://www.bsb-muenchen.de/ "https://www.bsb-muenchen.de/") (Munich) and the [State Library of Berlin](http://staatsbibliothek-berlin.de/ "http://staatsbibliothek-berlin.de/"), under the auspices of the RISM Editorial Network. The Bavarian State Library is responsible for the operation and technical implementation of the RISM Catalog.  
